...
public class AnimState_Upper_Blocking : AnimationState
{
    public AnimState_Upper_Blocking(AnimationStateManager animator) : base(animator) { }

    public override void EnterState()
    {
        SetUpperBodyBlendValue(1.0f);
        animStateManager.animator.animUpperBodyStateMachinePlayback.Travel("Fists_Blocking");
    }
